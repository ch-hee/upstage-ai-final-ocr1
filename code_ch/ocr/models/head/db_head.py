...
class DBHead(nn.Module):
    def __init__(self, in_channels=256, upscale=4, k=50, bias=False, smooth=False,
        ...
        self.adaptive_scale_fusion = AdaptiveScaleFusion(in_channels, in_channels // 4) if asf else None
    ...
    def forward(self, features, return_loss=True):
        ...
        if self.adaptive_scale_fusion:
            fuse = self.adaptive_scale_fusion(fuse, features)
